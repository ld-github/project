            ...
            (function(container) {
                window['expressinstallcallback'] = function(state) {
                    ...
                    case 'Download.Cancelled':
                        new Message('您取消了更新').show(false);
                        break;

                    case 'Download.Failed':
                        new Message('安装失败').show(false);
                        break;

                    default:
                        new Message('安装已成功，请刷新').show(false);
                        break;
                    }
    ...
    function updateStatus() {
        ...
        if (state === 'ready') {
            ...
            if (stats.uploadFailNum) {
                text = '已成功上传' + stats.successNum + '个文件到服务器，' + stats.uploadFailNum + '个文件上传失败，<a class="retry" href="#">重新上传</a>失败图片或<a class="ignore" href="#">忽略</a>';
            }
        } else {
            stats = uploader.getStats();
